...
window.onblur=function(){this.document.title='🚔: こちを見ろ！'}
...
button.addEventListener('click',function(){if($("span.ln",codeBlock)){codes=[]
codeBlock.querySelectorAll('span').forEach(function(codeSpan,i){if($(codeSpan).hasClass("ln")){if(i>0){codes.push("\n")}}else{codes.push(codeSpan.innerText)}})
codeText=codes.join("")}else{codeText=codeBlock.innerText}
clipboard.writeText(codeText).then(function(){button.blur()
