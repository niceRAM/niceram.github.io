...
button.addEventListener('click',function(){codes=[]
zip(codeBlock.querySelectorAll('span.ln'),codeBlock.innerText.split('\n')).forEach(codeMap=>{if(codeMap[0]&&codeMap[1]){codes.push(codeMap[1].replace(codeMap[0].innerText,''))}})
codeText=codes.join('\n')
